	...
	<div class="tw-flex tw-flex-col ">
		<div class="tw-w-full tw-flex">
			...
			<span class="tw-w-1/2 tw-text-right">
				<?php echo esc_html( $munim_currency_symbol ); ?> <?php echo number_format( $post->munim_estimate_subtotal ?? 0 ); ?>
			</span>
		</div>
		<div class="tw-w-full tw-flex tw-mb-2">
			...
			<span class="tw-w-1/2 tw-text-right">
				<?php echo esc_html( $munim_currency_symbol ); ?> <?php echo number_format( $post->munim_estimate_taxes_total ?? 0 ); ?>
			</span>
		</div>
		<div class="tw-w-full tw-flex tw-border-t tw-border-gray-300 tw-pt-2">
			...
			<span class="tw-w-1/2 tw-text-right">
				<?php echo esc_html( $munim_currency_symbol ); ?> <?php echo number_format( $post->munim_estimate_total ?? 0 ); ?>
			</span>
		</div>
	</div>
</div>
